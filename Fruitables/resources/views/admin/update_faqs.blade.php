     ...
     <div class="col-sm-12 col-xl-12">
        ...
        @endif
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="{{route('Faqs.update',['id'=>$faqs->id])}}" id="form"  method="post" enctype="multipart/form-data">
                                @csrf
                            <div class="position-relative mb-3">
                                <h3 class="mb-4 d-inline">Update Faqs</h3>        
                            ...
                            <div class="form-floating mb-3" id="destination">
                                <input type="text" name="destination" value="{{$faqs->question}}" class="form-control" id="Carddesti"
                            ...
                            <div class="form-floating" id="descriptu">
                                <textarea class="form-control" name="CardDesc" placeholder="Category Description"
                                    id="CardDesc" style="height: 290px;">{{$faqs->answer}}</textarea>
                                @error('CardDesc')
                                <div class="text-danger">{{$message}}</div> 
                             @enderror
                            </div>
