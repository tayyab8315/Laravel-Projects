...
<div class="container p-4">
    <div class="col-sm-12 col-xl-12">
        <div class="bg-secondary rounded h-100 p-4">
            <form action="{{ route('Product.update',['id'=>$prodCat->id])}}" method="POST"  enctype="multipart/form-data">
                @csrf
                <div class="position-relative mb-3">
                    <h3 class="mb-4 d-inline">Update Product</h3>
                    <a href="{{ route('Product-cat.index') }}" class="nav-item nav-link d-inline btn btn-dark position-absolute top-0 end-0">Back</a>
                </div>
                <div class="form-floating mb-3">
                    <input type="text" name="product_name" value="{{$prodCat->name}}" class="form-control" id="floatingInput" placeholder="Category Name">
                ...
                <div class="form-floating mb-3">
                    <input type="number" name="prod_price"  value="{{$prodCat->price}}" min="1" class="form-control" id="floatingInput" placeholder="Category Name">
                ...
                <div class="form-floating mb-3">
                    <input type="number" name="prod_discount"  value="{{$prodCat->discount}}" min="1" class="form-control" id="floatingInput" placeholder="Category Name">
                ...
                <div class="form-floating mb-3">
                   ...
                   <img height="50px" width="50px" src="{{asset('storage/'.$prodCat->image)}}" alt="">
                    @error('image')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <button type="submit" class="nav-item nav-link mt-3 btn btn-dark">Update Product</button>
            </form>
        </div>
    </div>
</div>
