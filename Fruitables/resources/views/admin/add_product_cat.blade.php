...
<div class="container p-4">
     <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <form action="{{route('Product-cat.store')}}" enctype="multipart/form-data" method="post">
                                @csrf
                            <div class="position-relative mb-3">
                                <h3 class="mb-4 d-inline">Add Product Category</h3>        
                            ...
                            <button type="submit" class="nav-item nav-link mt-3 btn btn-dark">Add Category</button>
                        </form>
                        </div>
                    </div>
                    </div>
