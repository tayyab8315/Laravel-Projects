...
<div class="container p-4">
     <div class="col-sm-12 col-xl-12">
                        <div class="bg-secondary rounded h-100 p-4 ">
                            <form action="{{route('Product-Subcat.update',['id'=>$prodCattt->id])}}" method="post">
                                @csrf
                            <div class="position-relative mb-3">
                                <h3 class="mb-4 d-inline">Update Product Sub Category</h3>        
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" name="catName" value="{{$prodCattt->sub_category_name}}" class="form-control" id="floatingInput"
                            ...
                            <div class="form-floating">
                                <textarea class="form-control" value="{{$prodCattt->sub_category_desc}}" name="catDesc" placeholder="Category Description"
                            ...
                            <button type="submit" class="nav-item nav-link mt-3 btn btn-dark">Update Sub Category</button>
                        </form>
                        </div>
                    </div>
                    </div>
